...
if DATABASE_URL:
    # Usa dj_database_url para parsear DATABASE_URL (Postgres)
    DATABASES = {
        'default': dj_database_url.parse(DATABASE_URL, conn_max_age=600, ssl_require=True)
    }
else:
    # Fallback: uso de variables separadas (útil para desarrollo local)
    DATABASES = {
        'default': {
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://sistema-indicadores-alcaldia.netlify.app",
]
